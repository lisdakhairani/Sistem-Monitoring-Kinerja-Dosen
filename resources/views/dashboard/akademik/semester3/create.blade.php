...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">semesterIII /</span> Add
    </h4>
    <div class="row">
            ...
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-12">
                        <div class="card-body">
                            <div class="col-lg-8">
                                <form method="POST" action="{{ route('semestertiga.store') }}"
                                    ...
                                    <div class="mb-3">
                                        <label for="kontrensasi" class="form-label">Kontrensasi</label>
                                        <input type="text"
                                            class="form-control @error('kontrensasi') is-invalid @enderror"
                                            id="kontrensasi" name="kontrensasi" autofocus
                                            value="{{ old('kontrensasi') }}" placeholder="Masukkan Kontrensasi">
                                        @error('kontrensasi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
