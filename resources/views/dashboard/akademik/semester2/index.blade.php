...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row mt-3">
                    ...
                    <div class="col-sm-12">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ route('semesterdua.create') }}">
                            ...
                            <table class="table table-striped table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('semesterdua.edit', $post->id) }}"
                                                class="badge bg-warning"><i class="bi bi-pencil-square"></i></a>

                                            <form action="{{ route('semesterdua.destroy', $post->id) }}" method="POST"
                                                class="d-inline">
                                                @method('DELETE')
                                                @csrf
        ...
        {{ $semester2->withQueryString()->links() }}
    </div>
</div>
@endsection