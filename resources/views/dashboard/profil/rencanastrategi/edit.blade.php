    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        <form method="POST" action="{{ route('rencanastrategi.update', $rencana->id) }}" class="mt-5"
                            ...
                            <div class="mb-3">
                                ...
                                @enderror
                                <input id="body" type="hidden" name="body" value="{{ old('body', $rencana->body) }}">
                                <trix-editor input="body"></trix-editor>
                            </div>

                            <div class="mb-3">
                                <label for="filedata" class="form-label">Post File</label>
                                <input type="hidden" name="oldImage" value="{{ $rencana->filedata }}">
                                @if ($rencana->filedata)
                                <img src="{{ asset('storage/' . $rencana->filedata) }}"
