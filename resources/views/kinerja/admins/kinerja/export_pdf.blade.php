...
<head>
    <meta charset="utf-8">
    <title>Laporan Kinerja Dosen - {{ $kinerja->dosen->name }}</title>
    <style>
        @page {
            size: A4;
            margin: 3cm;
...
<body>
    ...
    <div class="info-section">
        ...
        <div class="info-grid">
            ...
            <div class="highlight">{{ $kinerja->dosen->name }}</div>
    ...
    <div class="info-section">
        ...
        <div class="info-grid">
            ...
            <div class="highlight">{{ $kinerja->semester->nama_semester }} {{ $kinerja->semester->tahun_ajaran }}</div>

            <div class="info-label">Tanggal Pengisian</div>
            <div>{{ optional($kinerja->tanggal_pengisian)->format('d F Y') ?? '-' }}</div>

            <div class="info-label">Tanggal Validasi</div>
            <div>{{ optional($kinerja->tanggal_validasi)->format('d F Y') ?? '-' }}</div>

            <div class="info-label">Validator</div>
            <div>{{ $kinerja->validator->name }}</div>
    ...
    <div class="signature">
        ...
        <div class="signature-line">
            {{ $kinerja->validator->name }}
            <p>NIP. {{ $kinerja->validator->nip ?? '-' }}</p>
