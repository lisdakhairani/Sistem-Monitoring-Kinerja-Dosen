    ...
    <div class="card performance-card">
        ...
        <div class="card-body">
                    ...
                    <div class="lecturer-info-card mb-4">
                        ...
                        <div class="info-card-body">
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value">{{ optional($kinerja->tanggal_pengisian)->format('d F Y') ?? '-' }}</span>
                            </div>
                              <div class="info-item">
            ...
            <div class="action-buttons mt-4 text-center">
                ...
                <a href="{{ route('kinerja.export.excel', $kinerja->id) }}" class="btn btn-export-excel">
                    <i class="bi bi-file-earmark-excel me-2"></i>Excel
                </a>

                <a href="{{ route('kinerja.export.pdf', $kinerja->id) }}" class="btn btn-export-pdf">
                    <i class="bi bi-file-earmark-pdf me-2"></i>PDF
                </a>

                @if($kinerja->status_penilaian === 'Sedang Dinilai')
                <form action="{{ route('kinerja.edit', $kinerja->id) }}" method="GET" class="d-inline">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="status_penilaian" value="Selesai">
                    <input type="hidden" name="total_skor" value="{{ $totalScore }}">
                    <button type="submit" class="btn btn-complete">
                        <i class="bi bi-check-circle me-2"></i>Proses Penilaian
                    </button>
                </form>
                @endif
            </div>
