...
<div class="container py-4">
    <h3 class="mb-4">Data <span style="color: #008374">Kinerja Dosen</span></h3>
...
<!-- Export Buttons - Separate Forms -->
<div class="d-flex justify-content-end mb-3">
    <form method="GET" action="{{ route('kinerja.export.filtered.excel') }}" class="me-2">
    ...
    <form method="GET" action="{{ route('kinerja.export.filtered.pdf') }}">
        <input type="hidden" name="dosen_id" value="{{ request('dosen_id') }}">
        <input type="hidden" name="semester_id" value="{{ request('semester_id') }}">
        <input type="hidden" name="tahun" value="{{ request('tahun') }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('kinerja.update', $item->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('PUT')
                                    <input type="hidden" name="status_penilaian" value="Sedang Dinilai">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('kinerja.edit', $item->id) }}" method="GET" class="d-inline">
                                    @csrf
                                    @method('GET')

                                    <button type="submit" class="btn btn-success btn-sm">
                                        <i class="bi bi-check"></i> Nilai
                                    </button>
                                </form>
                            </td>
                        </tr>
