...
<div class="container py-4">
    <div class="card performance-card">
        <div class="card-header performance-header bg-primary text-white">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge performance-status-badge bg-{{
                    $kinerja->status_penilaian == 'Selesai' ? 'success' :
                    ($kinerja->status_penilaian == 'Sedang Dinilai' ? 'warning' : 'secondary')
                }}">
        ...
        <div class="card-body">
                    ...
                    <div class="lecturer-info-card mb-4">
                        ...
                        <div class="info-card-body">
                            <div class="info-item">
                                ...
                                <span class="info-value">{{ $kinerja->dosen->name }}</span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">NIP/NIDN</span>
                                <span class="info-value">{{ $kinerja->dosen->nip ?? '-' }} / {{  $kinerja->dosen->nidn ?? '-' }}</span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Jabatan</span>
                                <span class="info-value">{{ $kinerja->dosen->jabatan ?? '-' }} </span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Pangkat</span>
                                <span class="info-value">{{ $kinerja->dosen->pangkat ?? '-' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="lecturer-info-card mb-4">
                        ...
                        <div class="info-card-body">
                            <div class="info-item">
                                ...
                                <span class="info-value">{{ $kinerja->semester->nama_semester }} {{ $kinerja->semester->tahun_ajaran }}</span>
                            </div>
                           <div class="info-item">
                                <span class="info-label">Tanggal Pengisian</span>
                                <span class="info-value">{{ $kinerja->tanggal_pengisian->format('d F Y') }}</span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Tanggal Validasi</span>
                                <span class="info-value">{{ optional($kinerja->tanggal_validasi)->format('d F Y') ?? '-' }}</span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Validator</span>
                                <span class="info-value">{{ $kinerja->validator->name }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form action="{{ route('kinerja.updateScore', $kinerja->id) }}" method="POST">
                @csrf
                        ...
                        <table class="table performance-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <input type="number" name="pengajaran[{{ $loop->index }}][id]" value="{{ $pengajaran->id }}" hidden>
                                        <input type="number" step="0.01" min="0" max="100"
                                               name="pengajaran[{{ $loop->index }}][skor]"
                                               value="{{ old('pengajaran.'.$loop->index.'.skor', $pengajaran->skor) }}"
                        ...
                        <table class="table performance-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <input type="number" name="penelitian[{{ $loop->index }}][id]" value="{{ $penelitian->id }}" hidden>
                                        <input type="number" step="0.01" min="0" max="100"
                                               name="penelitian[{{ $loop->index }}][skor]"
                                               value="{{ old('penelitian.'.$loop->index.'.skor', $penelitian->skor) }}"
                                               class="form-control score-input text-center">
                                    </td>
                                </tr>
                                @empty
                        ...
                        <table class="table performance-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <input type="number" name="pengabdian[{{ $loop->index }}][id]" value="{{ $pengabdian->id }}" hidden>
                                        <input type="number" step="0.01" min="0" max="100"
                                               name="pengabdian[{{ $loop->index }}][skor]"
                                               value="{{ old('pengabdian.'.$loop->index.'.skor', $pengabdian->skor) }}"
                                               class="form-control score-input text-center">
                                    </td>
                                </tr>
                                @empty
                        ...
                        <table class="table performance-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <input type="number" name="penunjang[{{ $loop->index }}][id]" value="{{ $penunjang->id }}" hidden>
                                        <input type="number" step="0.01" min="0" max="100"
                                               name="penunjang[{{ $loop->index }}][skor]"
                                               value="{{ old('penunjang.'.$loop->index.'.skor', $penunjang->skor) }}"
                                               class="form-control score-input text-center">
                                    </td>
                                </tr>
                                @empty
                ...
                <div class="action-buttons mt-4 text-center">
                    <a href="{{ route('kinerja.index') }}" class="btn btn-back">
